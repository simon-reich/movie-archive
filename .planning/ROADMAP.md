...
- [ ] 15-04-PLAN.md — Gap closure: fix NuxtLink navigation (resolveComponent), PARSE_ERROR always-row display, four-section status grouping, resolve-widget full-width breakout (G-15-2, G-15-3)
