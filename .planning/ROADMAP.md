...
- [x] 15-05-PLAN.md — Gap closure: render candidate title + year as visible text in both resolve-candidate blocks (G-15-4)
- [x] 15-06-PLAN.md — Gap closure: drop `truncate` from resolve-candidate-label so long titles wrap instead of clipping the year (G-15-5)
